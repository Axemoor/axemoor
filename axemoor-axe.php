...
<div class="blog-header">
      ...
      <div class="row">
        ...
        <div class="col-sm-8 blog-main">
          ...
          <div class="blog-post">
            <h2 class="blog-post-title">Order of the Axe</h2>
            <p>Award Citation: "It has come to our notice that because of your
              outstanding service, you (name) have encouraged the populace to
              strive for excellence. In recognition of your service, we are
              pleased to award you with the Order of the Axe. We charge you to
              continue to strive for excellence and to encourage the populace,
              seeking always to serve the Barony of Axemoor to the greater
              glory of Gleann Abhann."</p>

            <p>  <?php  // open our php code

      // Initialize the cURL session and set the source URL.
      // Substitute in the individual's ID where "245" is
      $ch = curl_init("http://dev.records.gleannabhann.net/api/award_recip.php?id=93");
